...
MIGRAÇÃO (Fase 2):
-----------------
Extrair do atual `udemy_transcripter/enricher.py` a classe/função que chama Claude.
...
importa tardiamente via factory, então só quem usa Claude precisa ter a lib instalada.
"""

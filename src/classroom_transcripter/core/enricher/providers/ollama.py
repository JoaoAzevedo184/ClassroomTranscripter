...
MIGRAÇÃO (Fase 2):
-----------------
Extrair do atual `udemy_transcripter/enricher.py` a classe/função que chama Ollama.
...
importa tardiamente via factory, então só quem usa Ollama precisa ter a lib instalada.
"""
